...
//
// DISABLED: Shift+hover targeting (red .emit outlines, .target / .consumed
// highlights, cross-page align-item scroll) is unfinished and fights desktop
// Shift-copy item drag. Re-enable TARGETING_UI when the consume/emit
// relationship UX is designed properly.

const TARGETING_UI = false
