...
const bind = function () {
  ...
  $(window).on('blur', () => stopTargeting({ shiftKey: false })) // wiki lost focus
  $('.main')
...
// Is Shift down on this event? (keyboard state, not our targeting flag)
const shiftHeld = function (e) {
  if (e.getModifierState) return e.getModifierState('Shift')
  return e.shiftKey
}
